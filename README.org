...
*** Dependencies
    :PROPERTIES:
    :ID:       8065a793-971f-4f3d-9c4b-597f8b9bc112
    :END:
#+BEGIN_SRC python
  import RPi.GPIO
  import logging
...
*** Define =Pin= Class
    :PROPERTIES:
    :ID:       f11f3225-6137-4f36-a090-76a72d94a148
    :END:
#+BEGIN_SRC python
  class Pin:
      VOLT = 1
...
*** Writing Pins
    :PROPERTIES:
    :ID:       59d69f00-7cca-47f5-8ed0-322720af4243
    :END:
#+BEGIN_SRC python
...
*** Reading Pins
    :PROPERTIES:
    :ID:       eb47ab73-eeb3-492b-9025-df775818e56f
    :END:
#+BEGIN_SRC python
  def read_pin(pin):
...
*** Toggling Pins
    :PROPERTIES:
    :ID:       491f0d8c-50e8-4a16-8f2f-c3754d5a6450
    :END:
#+BEGIN_SRC python
  def toggle(pin):
      assert pin.mode is RPi.GPIO.OUT
...
*** Setup Loop
    :PROPERTIES:
    :ID:       b975a3b8-86da-45af-b441-f0972b32c1f0
    :END:
#+BEGIN_SRC python
  def setup_all(pins):
